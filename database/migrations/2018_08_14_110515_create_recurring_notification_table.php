...
class CreateRecurringNotificationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('recurring_notification_logs', function($table) {
            $table->increments('id');
    ...
    {
        Schema::drop('recurring_notification_logs');
    }
}
